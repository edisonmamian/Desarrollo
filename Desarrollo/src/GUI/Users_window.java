...
public class Users_window extends javax.swing.JFrame {
    ...
    private void boton_actualizarusuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_actualizarusuarioActionPerformed
        ...
        Actualizar_usuarioActualizar_usuario obj_actua_user = new Actualizar_usuarioActualizar_usuario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Users_window.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Users_window().setVisible(true);
            }
        });
    }
